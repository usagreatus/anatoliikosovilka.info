...
function resumee_customize_register( $wp_customize ) {
	...
	// colophon text 
	$wp_customize->add_setting('resumee[colophon_txt]',array(
		          'default'         => esc_html__('Contact : Seasame Street, 1st Floor San Francisco, CA 12345', 'resumee'),
		          'sanitize_callback' => 'sanitize_hex_color',
		          'transport'       => 'postMessage',
		          'sanitize_callback' => 'resumee_sanitize_text',
		          'type'            => 'option',
