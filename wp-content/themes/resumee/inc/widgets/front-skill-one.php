...
//register widget backend
     ...
     */ 
      ...
      <!-- title field -->
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:' , 'resumee'); ?></label><span style="font-size: 12px;vertical-align: bottom;"><?php _e('This field accepts html', 'resumee'); ?></span>
        <br>
      ...
      <!-- skill1 field -->
        <label for="<?php echo $this->get_field_id('skill1'); ?>"><?php _e('Skill:' , 'resumee'); ?></label><span style="font-size: 12px;vertical-align: bottom;"><?php _e('This field accepts html', 'resumee'); ?></span>
        <br>
      ...
      <!-- skill2 field -->
        <label for="<?php echo $this->get_field_id('skill2'); ?>"><?php _e('Skill:' , 'resumee'); ?></label><span style="font-size: 12px;vertical-align: bottom;"><?php _e('This field accepts html', 'resumee'); ?></span>
        <br>
      ...
      <!-- skill3 field -->
        <label for="<?php echo $this->get_field_id('skill3'); ?>"><?php _e('Skill:' , 'resumee'); ?></label><span style="font-size: 12px;vertical-align: bottom;"><?php _e('This field accepts html', 'resumee'); ?></span>
        <br>
      ...
      <!-- skill4 field -->
        <label for="<?php echo $this->get_field_id('skill4'); ?>"><?php _e('Skill:' , 'resumee'); ?></label><span style="font-size: 12px;vertical-align: bottom;"><?php _e('This field accepts html', 'resumee'); ?></span>
        <br>
