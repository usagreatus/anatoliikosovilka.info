...
function personalportfolio_wp_footer () { ?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<?php printf( __( 'Proudly powered by %s', 'personal-portfolio' ), 'WordPress' ); ?>
			<span class="sep"> &amp; </span>
			<?php printf(
			__( '%1$s by %2$s.', 'personal-portfolio' ),
			'<strong>'.__('Personal Portfolio WordPress Theme', 'personal-portfolio' ).'</strong>',
