...
if (!class_exists('cvcard_Redux_Framework_config')) {

    class cvcard_Redux_Framework_config {
                ...
                'fields'    => array(
                    ...
                    array(
                     ...
                     array(
                        'id'        => 'opt-js',
                        'type'      => 'ace_editor',
                        'title'     => __('jQuery Code', 'redux-framework-demo'),
                        'subtitle'  => __('Paste your jQuery code here.', 'redux-framework-demo'),
                        'mode'      => 'javascript',
                        'theme'     => 'chrome',
                        'desc'      => 'Possible modes can be found at <a href="http://ace.c9.io" target="_blank">http://ace.c9.io/</a>.',
                    ...
                    array(
                        ...
                        'default'  => __('Copyright 2014 CV Card. All Rights Reserved.', 'redux-framework'),
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'your_photo',
                        'type'      => 'media',                        
                        'title'     => __('Your Photo', 'redux-framework'),             
                    ...
                    array(
                        'id'        => 'your_name',
                        'type'      => 'text',
                        'title'     => __('Your Name', 'redux-framework-demo'),
                        'subtitle'  => __('It will place below the your photo.', 'redux-framework-demo'),                        
                    ...
                    array(
                        'id'        => 'your_job',
                        'type'      => 'text',
                        'title'     => __('Your Job', 'redux-framework-demo'),
                        'subtitle'  => __('It will place below the your photo.', 'redux-framework-demo'),                        
                        'validate'  => 'str_replace',                        
                    ),  
                    ...
                    array(
                        'id'        => 'upload_resume',
                        'type'      => 'media',
                        'title'     => __('Resume File', 'redux-framework-demo'),
                        'compiler'  => 'true',
                        'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                        'desc'      => __('You can upload your resume.', 'redux-framework-demo'),
                        'subtitle'  => __('File format should be .zip', 'redux-framework-demo'),
        ...
        public function setHelpTabs() {
            ...
            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-1',
                'title'     => __('CV Card', 'redux-framework-demo'),
...
// SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    ...
    global $reduxConfig;
    $reduxConfig = new cvcard_Redux_Framework_config();
}

/**
  Custom function for the callback referenced above
 */
if (!function_exists('cvcard_my_custom_field')):
    function cvcard_my_custom_field($field, $value) {
        print_r($field);
        echo '<br/>';
        print_r($value);
    }
 ...
 * */
if (!function_exists('cvcard_validate_callback_function')):
    function cvcard_validate_callback_function($field, $value, $existing_value) {
        $error = false;
        $value = 'just testing';
