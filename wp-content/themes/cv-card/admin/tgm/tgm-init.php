...
function starter_plugin_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'               => 'Portfolio Post', // The plugin name.
            'slug'               => 'portfolio-type', // The plugin slug (typically the folder name).
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'external_url'		 => 'https://wordpress.org/plugins/portfolio-type/'
        ),
	);
